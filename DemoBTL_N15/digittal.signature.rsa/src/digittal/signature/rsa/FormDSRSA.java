...
//      jProgressBar1 = new JProgressBar();
    ...
    private void initComponents() {
        ...
        jLabel15.setForeground(new java.awt.Color(188, 143, 143));
        jLabel15.setText("Digital Signature Software");

        jLabel18.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(188, 143, 143));
        jLabel18.setText("BTL ATBMTT GROUP 15");
        ...
        jMenuItem2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JOptionPane.showMessageDialog(null, "BTL thuộc học phần An toàn bảo mật thông tin"
                		+ "\nDemo chương trình ứng dụng RSA vào chữ ký số điện tử"
                		+ "\nNhóm 15 thực hiện!", "Thông tin", JOptionPane.INFORMATION_MESSAGE);
            }
        });
        ...
        jMenuItem3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JOptionPane.showMessageDialog(null, "....", "Hướng dẫn", JOptionPane.INFORMATION_MESSAGE);
            }
        });
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jLabel16.setForeground(new java.awt.Color(255, 245, 238));
        jLabel17.setText("Đã có khóa công khai");
        jLabel17.setForeground(new java.awt.Color(255, 245, 238));
